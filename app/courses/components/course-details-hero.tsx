...
import { Iconify, Image, Label } from '#shared/components';
import { fShortenNumber } from '#shared/utils/format-number';
import { PlayerDialog } from '#shared/components/player';
            ...
            >
                <Container sx={{ overflow: 'hidden' }}>
                    <CustomBreadcrumbs
                        links={[
                            { name: 'Home', href: '/' },
                            { name: 'Courses', href: PATHS.COURSE.ROOT },
                            { name: course.slug || '' },
                        ]}
                        sx={{
                            pt: 5,
