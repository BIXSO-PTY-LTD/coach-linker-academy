...
import { ICourseFiltersProps } from '#shared/typescript/course';
import { ICountriesProps } from '#shared/typescript/contact';
...
export default function CourseFilters({ open, onClose }: Props) {
    ...
    const renderContent = (
        ...
        >
            ...
            <Block title="Duration">
                <FilterDuration filterDuration={filters.filterDuration} onChangeDuration={handleChangeDuration} />
            </Block>
            ...
            <Block title="Language">
                <FilterLanguage filterLanguage={filters.filterLanguage} onChangeLanguage={handleChangeLanguage} />
            </Block>
        </Stack>
    );
