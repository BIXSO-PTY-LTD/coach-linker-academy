...
import Label from '#shared/assets/illustrations/pattern/label';
import Icon from '#shared/assets/illustrations/pattern/icon';
import Pattern01 from '#shared/assets/illustrations/pattern/pattern-01';
import Pattern02 from '#shared/assets/illustrations/pattern/pattern-02';
import Shape from '#shared/assets/illustrations/pattern/shape';
...
function HomeHeroIllustration({ sx, ...other }: BoxProps) {
